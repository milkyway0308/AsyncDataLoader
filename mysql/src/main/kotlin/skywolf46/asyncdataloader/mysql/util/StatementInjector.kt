...
class StatementInjector(private val main: PreparedStatement) : PreparedStatement, IStatementInput {
    private var currentCursor = 1
    private var isWarned = false
    private var filter = mutableListOf<IByteFilter>()
    ...
    override fun appendByteArray(arr: ByteArray) {
        if (filter.size == ignoredFilter.size) {
    ...
    override fun reset(unit: IStatementInput.() -> Unit) {
        TODO("Not yet implemented")
    }
    ...
    override fun execute(obj: List<Any>) {
        TODO("Not yet implemented")
    }
